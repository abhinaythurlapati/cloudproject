							...
							if(received.plan == 'LOCAL'){
								...
								if(data[0].localtariff[0].count == 0)
								{
									...
									for (var i = 1; i <= data[0].localtariff[0].count; i++) {
										...
										var estimated_cost = Math.round(data[0].localtariff[i].threshold + (tmp1 + tmp2 + tmp3 + tmp4 + tmp5 + tmp6)/100);
										estimated_cost = Math.round(estimated_cost / data[0].localtariff[i].recharge_validity);
								...
								if(data[0].localstdtariff[0].count == 0)
								{
									...
									for (var i = 1; i <= data[0].localstdtariff[0].count; i++) {
										...
										var estimated_cost = Math.round(data[0].localstdtariff[i].threshold + (tmp1 + tmp2 + tmp3 + tmp4 + tmp5 + tmp6)/100);
										estimated_cost = Math.round(estimated_cost / data[0].localstdtariff[i].recharge_validity);
